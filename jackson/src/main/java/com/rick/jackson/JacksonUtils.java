...
public class JacksonUtils {
    ...
    public static String parseStr(Object obj) {
        ...
        try {
            ...
            log.error("jackson parseStr error", e);
            throw new RuntimeException(e);
        }
    }

    public static String parseStrPretty(Object obj) {
        if (obj == null) {
            return "";
        }
        try {
            ...
            log.error("jackson parseStrPretty error", e);
            throw new RuntimeException(e);
        }
    }
    ...
    public static <T> T parseObj(String str, Class<T> clazz) {
        ...
        try {
            ...
            log.error("jackson parseObj error", e);
            throw new RuntimeException(e);
        }
    }
    ...
    public static <T> T parseRef(String str, TypeReference<T> ref) {
        ...
        try {
            ...
            log.error("jackson parseRef error", e);
            throw new RuntimeException(e);
        }
    }
